...
USER = {
    'name': u'Daniel',
    'avatar': u'http://ww1.sinaimg.cn/mw690/68c441e7gw1dw9ttg9eyvj.jpg',
    'avatar_large': u'http://ww4.sinaimg.cn/mw690/68c441e7jw1e4izdtfvc6j20m80goafn.jpg',
    'email': u'danewang@mail.ustc.edu.cn',
    'weibo': u' http://weibo.com/danewang',
    'intro': u'''
    	来自安徽亳州，正在所谓的'南七技校'求学的一名普通程序员,\
	爱好读书、美剧，喜爱一些不是太剧烈的运动 比如 乒乓、
	羽毛球...。你可以微波粉我，^_^ 
    '''
}
#
